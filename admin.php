...
<head>
    ...
    <link rel="icon" href="assets/img/lara-logo.jpg" type="">
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php"> <img src="assets/img/lara-logo.jpg" alt="" width="30px"> Lara Komputer</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <div class="sb-sidenav-menu-heading">Lara Computer</div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $em; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning text-white" data-toggle="modal" data-target="#edit<?= $iduser; ?>">
                                                    Edit
                                                </button>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Rieski Dhanu Saputra &copy; Lara Komputer</div>
